...
exports.DefaultDatasource = undefined;
...
var DefaultDatasource = exports.DefaultDatasource = function () {
  ...
  _createClass(DefaultDatasource, [{
    ...
    value: function buildQueryParameters(options) {
      ...
      options.parameters = _lodash2.default.filter(options.targets, function (target) {
        return target.field !== 'select metric';
      });

      if (options.targets.length > 0 && options.targets[0].targets !== undefined) options.parameters = _lodash2.default.filter(options.targets[0].targets, function (target) {
