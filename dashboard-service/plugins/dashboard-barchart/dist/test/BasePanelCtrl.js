...
exports.BasePanelCtrl = undefined;
...
var _BasePanelTabCtrl = require("./BasePanelTabCtrl");

var _drilldown = require("./drilldown");

require("./drilldown.css!");
...
var BasePanelCtrl = exports.BasePanelCtrl = function (_PanelCtrl) {
    ...
    function BasePanelCtrl($scope, $injector) {
        ...
        if (!$injector.has('finraDrilldownDirective')) {
            _angular2.default.module('grafana.directives').directive('finraDrilldown', _drilldown.finraDrilldownDirective);
        }
    ...
    _createClass(BasePanelCtrl, [{
        ...
        value: function _onInitMetricsPanelEditMode() {
            this.addEditorTab('Query', _BasePanelTabCtrl.queryTabDirective);
        }
    }, {
        key: "_setDataSouce",
        ...
        value: function updateTimeRange(datasource) {
            ...
            if (this.panel.maxDataPoints) {
                ...
                this.resolution = Math.ceil((0, _jquery2.default)(window).width() * (this.panel.span / 12));
            }
        ...
        value: function calculateInterval() {
            ...
            var res = _kbn2.default.calculateInterval(this.range, this.resolution, intervalOverride);
        ...
        value: function applyPanelTimeOverrides() {
            ...
            if (this.panel.timeFrom) {
                ...
                if (_lodash2.default.isString(this.rangeRaw.from)) {
        ...
        value: function removeQuery(target) {
            var index = _lodash2.default.indexOf(this.panel.targets, target);
